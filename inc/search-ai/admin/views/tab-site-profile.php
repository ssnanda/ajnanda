...
<form method="post" action="<?php echo esc_url(admin_url('admin-post.php')); ?>">
    ...
    <div class="ajnanda-admin-section">
        ...
        <table class="form-table" role="presentation">
            <tr><th><label for="search_ai_profile_website"><?php esc_html_e('Website URL', 'ajnanda'); ?></label></th><td><input class="regular-text" type="text" id="search_ai_profile_website" name="search_ai_profile_website" value="<?php echo esc_attr($profile['website_input']); ?>" placeholder="/"><p class="description"><?php esc_html_e('Use a root-relative path (usually /) so environment syncs remain portable.', 'ajnanda'); ?></p></td></tr>
