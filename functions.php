...
function ncllc_pro_scripts() {
    ...
    wp_enqueue_style('ncllc-pro-style', get_stylesheet_uri(), array(), '1.0.29');
    
    // Enqueue custom JavaScript
    wp_enqueue_script('ncllc-pro-script', get_template_directory_uri() . '/js/main.js', array('jquery'), '1.0.29', true);
...
function ncllc_pro_block_editor_assets() {
    wp_enqueue_style('ncllc-pro-editor-style', get_stylesheet_uri(), array(), '1.0.29');
    wp_enqueue_script(
