<?php
/**
 * Title: Content — Large Statement
 * Slug: ajnanda/section-content-large-statement
 * Categories: ajnanda-content
 * Keywords: content, statement, editorial, bold
 * Description: A single large, centered editorial statement — good for a mission line or bold mid-page pause. Uses the "x-large" font-size preset.
 *
 * @package AJNanda
 */
?>
